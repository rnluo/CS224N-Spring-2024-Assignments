...
\end{lstlisting}
    ...
    \ifans{} \\
    The masks set the attention scores that correspond to pad tokens to negative infinity. This is necessary because padding tokens do not contain any semantic information and should not be incorporated into computation.
...
\end{lstlisting}
    ...
    \ifans{} Corpus BLEU: 19.628878912707993
    ...
    \ifans{} \\
    Advantage: Computationally efficient. Disadvantage: Requires the dimensions of the key and the query to be the same; lacks a learned transformation.

    \subpart[2] Explain one advantage and one disadvantage of \textit{additive attention} compared to multiplicative attention.
    
    \ifans{} \\
    Advantage: More expressive due to the nonlinearity introduced by tanh. Disadvantage: More parameters and computations.
