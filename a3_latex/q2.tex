...
\begin{parts}
    ...
    \ifans{} A 1D convolutional layer can learn local patterns and detect compositional relationships. For example, it may find that 电 and 脑 frequently cooccur and learn that it should be represented as a unified feature.
    ...
    \begin{subparts}
        ...
        \ifans{} This may be problematic as a single reference cannot capture multiple correct translations, resulting in over-penalizing alternative versions and bias toward the specific wording. \\
        BLEU is more robust with multiple reference translations because it may match n-grams across diversed versions.

        \subpart[2] List two advantages and two disadvantages of BLEU, compared to human evaluation, as an evaluation metric for Machine Translation. 
        
        \ifans{} \\
        \textbf{Advantages: } Much faster and less expensive; objective and repeatable. \\
        \textbf{Disadvantages: } Not aligned to human preferences; have no notion of semantics, resulting in false negatives and false positives.
